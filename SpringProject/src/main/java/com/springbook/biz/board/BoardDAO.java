...
public class BoardDAO {
	...
	// ±âº» CRUD
	private final String Board_Insert = "INSERT INTO BOARD(boardTitle, boardWriter, boardContent, store_Num) VALUES(?,?,?,?)";
	private final String Board_Update= "UPDATE BOARD SET boardTitle=?, BoardWriter=?, boardContent=? WHERE boardNum=?";
	private final String Board_Delete= "DELETE FROM BOARD WHERE boardNum=?";
	...
	public void insertBoard(BoardVO vo) {
		Object[] args = { vo.getBoardTitle(), vo.getBoardWriter(), vo.getBoardContent(), vo.getStore_Num() };
